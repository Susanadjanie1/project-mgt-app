...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "project" | "projectAssignment" | "task"
    ...
    model: {
      ...
      ProjectAssignment: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.ProjectAssignmentFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.ProjectAssignmentAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type ProjectOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "description" | "status" | "createdAt", ExtArgs["result"]["project"]>
  ...
  export type ProjectAssignmentOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "projectId" | "userId", ExtArgs["result"]["projectAssignment"]>
  ...
  export interface ProjectAssignmentDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more ProjectAssignments that matches the filter.
     * @param {ProjectAssignmentFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const projectAssignment = await prisma.projectAssignment.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: ProjectAssignmentFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a ProjectAssignment.
     * @param {ProjectAssignmentAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const projectAssignment = await prisma.projectAssignment.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: ProjectAssignmentAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  /**
   * ProjectAssignment findRaw
   */
  export type ProjectAssignmentFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * ProjectAssignment aggregateRaw
   */
  export type ProjectAssignmentAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type TaskOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "status" | "dueDate" | "createdAt" | "projectId" | "userId", ExtArgs["result"]["task"]>
  ...
  export type UserCreateInput = {
    ...
    email: string
    role: string
    assignments?: ProjectAssignmentCreateNestedManyWithoutUserInput
  ...
  export type UserUncheckedCreateInput = {
    ...
    email: string
    role: string
    assignments?: ProjectAssignmentUncheckedCreateNestedManyWithoutUserInput
  ...
  export type UserUpdateInput = {
    ...
    assignments?: ProjectAssignmentUpdateManyWithoutUserNestedInput
  ...
  export type UserUncheckedUpdateInput = {
    ...
    email?: StringFieldUpdateOperationsInput | string
    role?: StringFieldUpdateOperationsInput | string
    assignments?: ProjectAssignmentUncheckedUpdateManyWithoutUserNestedInput
